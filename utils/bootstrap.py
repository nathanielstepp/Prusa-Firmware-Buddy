...
def switch_to_venv_if_nedded():
    if not running_in_venv and os.environ.get('BUDDY_NO_VIRTUALENV') != '1':
        if not os.path.exists(".venv"): # NSTEPP | 2024/04/24
            print('Creating needed virtual environment in .venv') # NSTEPP | 2024/04/24
            os.system(sys.executable + ' -m venv .venv') # NSTEPP | 2024/04/24
